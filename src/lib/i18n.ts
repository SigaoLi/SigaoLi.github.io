...
export const ui = {
  en: {
    ...
    chat: {
      open: 'Ask AI about Sigao',
      title: 'AI Assistant',
      subtitle: 'Ask anything about Sigao — work, research, photography.',
      greeting: "Hi — I'm the AI assistant on this site. Ask me anything about Sigao: his work, projects, research, or photography.",
      placeholder: 'Type a question…',
      send: 'Send',
      disclaimer: 'AI-generated. For anything important, confirm by email.',
      close: 'Close chat',
      errRate: 'Too many requests — please wait a minute and try again.',
      errTurns: 'This conversation has reached its limit — start a new one below.',
      errUpstream: 'The assistant is temporarily unavailable. Please try again later.',
      errNetwork: 'Network error — please try again.',
      reset: 'New conversation',
      suggestions: [
        'What does Sigao do right now?',
        'What are his most notable projects?',
  ...
  zh: {
    ...
    chat: {
      open: '问 AI 了解思高',
      title: 'AI 助手',
      subtitle: '关于思高的一切，都可以问——工作、研究、摄影。',
      greeting: '你好，我是这个网站的 AI 助手。关于思高的工作、项目、研究或摄影，都可以问我。',
      placeholder: '输入问题…',
      send: '发送',
      disclaimer: 'AI 生成，重要事项请以邮件与本人确认。',
      close: '关闭对话',
      errRate: '请求太频繁了，请稍等一分钟再试。',
      errTurns: '本次对话已达轮数上限——点击下方开始新对话。',
      errUpstream: '助手暂时不可用，请稍后再试。',
      errNetwork: '网络错误，请重试。',
      reset: '开始新对话',
      suggestions: ['他现在在做什么工作？', '他最有代表性的项目是什么？', '他的技术栈是什么？', '可以怎么联系他？'],
    },
    hero: {
