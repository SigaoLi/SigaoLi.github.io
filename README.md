...
- **Built-in AI layer** — a floating chat assistant on every page plus a personal MCP server, both fed by a build-time knowledge pack generated from the same sources as the pages (see below)
